...
<div class="mbox fw">
   ...
   <ul class="infolst">
   <?php if(is_array($docu_list)){foreach($docu_list as $mymps) { ?>   	<li class="linkdetail" onclick="javascript:window.location.href='index.php?mod=store&action=docu&id=<?=$store['id']?>&docuid=<?=$mymps['id']?>'">
            <dd class="tit" style=""><?=$mymps['title']?></dd>
