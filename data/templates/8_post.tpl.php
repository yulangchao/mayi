...
<?php include mymps_tpl('header_search'); ?>
 ...
 <div class="inp_Itembox">
   <dl class="cfix">
   <dt>类别</dt>
   <dd><?=$info['catname']?> <? if(!$id && !$child) { ?><a href="index.php?mod=post&cityid=<?=$cityid?>">(重选)</a><?php } ?></dd>
   <? if($child) { ?>
   <div class="menu">
    <i></i>
    <i></i>
  ...
  <dl class="cfix">
   <dt>区域</dt>
   <dd><? echo select_where_option('/include/selectwhere.php',$info['cityid']?$info['cityid']:$cityid,$info['areaid'],$info['streetid']);; ?></dd>
   <div class="menu">
    <i></i>
    <i></i>
    <i></i>
...
<div class="menu">
 ...
 <div class="inp_Itembox">
  ...
  <dl class="cfix">
   <dt>微信</dt>
   <dd><input type="text" id="qq" placeholder="请输入微信" name="qq" value="<?=$info['qq']?>" /></dd>
  </dl>
 </div>
