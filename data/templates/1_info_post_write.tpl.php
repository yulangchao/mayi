...
<div class="contact">
            <div class="p-line">
                ...
                <div class="publish-detail-item">
                    <input name="contact_who" type="text" class="input input-large" value="<?=$post['contact_who']?>" require="true" msg="请填写您的称呼，如刘女士"/>
                </div>
            </div>
            ...
            <div class="p-line">
                <label class="p-label">  联系微信：</label>
                <div class="publish-detail-item">
                    <input name="qq" type="text" class="input input-large" value="<?=$post['qq']?>"/>
                </div>
            </div>
