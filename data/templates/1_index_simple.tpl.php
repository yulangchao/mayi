...
<div class="category_inner">
        ...
        <?php if(is_array($firstcats)){foreach($firstcats as $mymps) { ?>        <div class="ni-fbg">
            ...
            <div class="postinfos"><a href="<?=$mymps_global['SiteUrl']?>/<?=$mymps_global['cfg_postfile']?>?catid=<?=$mymps['catid']?>&cityid=<?=$cityid?>" target="_blank">+发布<?=$mymps['catname']?></a></div>
        </div>
        ...
        <div class="clearfix"></div>
        <div class="smp_box">
        <div class="smp_box_title"><?=$city['cityname']?>站信息速递</div>
        <ul>
            <?php $ninfo = mymps_get_infos(12,NULL,NULL,NULL,NULL,NULL,NULL,NULL,$city['cityid']); ?>            <?php if(is_array($ninfo)){foreach($ninfo as $mymps) { ?>            <li><a title="<?=$mymps['title']?>" href='<?=$mymps['uri']?>'  style='' target=_blank><? echo cutstr($mymps['title'],24); ?></a> [<em><a href='<?=$mymps['uri_cat']?>' target=_blank><?=$mymps['catname']?></a></em>]</li>
            <?php }} ?>
        </ul>
        </div>
