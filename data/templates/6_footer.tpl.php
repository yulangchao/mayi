...
<div class="foot">
    <div class="footer">
        <ul>
            ...
            <div class="foot_copyright">版权所有：<?=$store['tname']?> 联系电话：<?=$store['tel']?><br />联系地址：<?=$store['address']?> <?=$mymps_global['SiteStat']?> <font class="none">powered by <a href="http://beimei.online">mymps</a></font></div>
        </ul>
    </div>
</div>
<div class="floater">
