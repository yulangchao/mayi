...
<a href="index.php?mod=category&catid=<?=$mymps['catid']?>&cityid=<?=$cityid?>"><?=$mymps['catname']?></a>
<span class="apost"><a href="index.php?mod=post&catid=<?=$mymps['catid']?>&cityid=<?=$cityid?>">发信息<i class="filt-arrowright"></i></a></span>
</div>
