...
<div class="rollBox">
        ...
        <div id="bm_indexcatad_<?=$portaluri['catidershou']?>"></div>
        <div class="ershou">
            <div class="hd">
        ...
        <div class="clearfix"></div>
        <div id="bm_indexcatad_<?=$portaluri['catidzufang']?>"></div>
        <div class="house">
            <div class="zufang">
                <div class="hd">
        ...
        <div id="bm_indexcatad_<?=$portaluri['catidershoufang']?>"></div>
        <div id="bm_indexcatad_<?=$portaluri['catidzhaopin']?>"></div>
        <div class="clearfix"></div>
        ...
        <div class="clearfix"></div>
        <div id="bm_indexcatad_<?=$portaluri['catidjianli']?>"></div>
